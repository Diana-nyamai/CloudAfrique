    ...
    <div>
      <div className="relative bg-blue h-full py-36 flex flex-col lg:flex-row justify-center items-center lg:px-32 pb-32">
        <div className="text-white px-5 xl:w-1/2 mt-10">
          <h1 className="text-white text-2xl lg:text-6xl capitalize mb-4 font-playfair text-center animate__animated animate__fadeInDown">
      ...
      <div className="mt-6">
        ...
        <div className="flex gap-6 justify-center items center flex-wrap my-5">
          {features.map((item, index) => (
            <div
              className="bg-lightBlue p-4 lg:w-1/4 mx-4"
              key={index}
              data-aos="zoom-in"
            >
      ...
      <div className="px-10 lg:mt-36">
        <div className="flex items-center gap-3 mb-2 justify-center">
          <h3 className="text-orange font-montserrat text-center">
            Our Fun Facts
          </h3>
          <p className="w-20 border-b-2 border-orange"></p>
        </div>
        <h1 className="font-playfair text-3xl font-semibold text-center">
        ...
        <div className="flex gap-5 my-10 justify-center flex-wrap">
          {funFacts.map((fact, index) => (
            <div
              className="bg-lightBlue p-4 w-full lg:w-[20%] flex flex-col justify-center items-center"
              key={index}
              data-aos="flip-right"
            >
              <img src={fact.icon} alt="donate" className="w-20" />
              <h3 className="mt-6 font-playfair font-semibold text-3xl">
                {fact.number} +
              </h3>
      ...
      {/* our gallery */}
      <div className="pt-20">
        <h2 className="text-3xl font-playfair font-semibold px-10 py-6 text-center">
