      ...
      <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          <div className="w-auto">
            <a className="text-blueColor flex items-center gap-3" href="/">
              <img src={images.logo} alt="logo" className="w-1/4" />
              <span className="font-semibold text-lg">Cloud Afrique</span>
              <path
          ...
          <div className="hidden md:block">
            <nav aria-label="Global text-blueColor">
              <ul className="flex items-center gap-6 text-sm">
                ...
                <li>
                  <a className="transition hover:text-orange" href="/about">
                    {" "}
                    About{" "}
                  </a>
                </li>
          ...
          <div className="flex items-center gap-4">
            <div className="sm:flex sm:gap-4">
              <a
                className="rounded-md bg-orange px-5 py-2.5 text-sm font-medium text-white shadow"
                href="/donate"
              >
                Donate
              </a>
